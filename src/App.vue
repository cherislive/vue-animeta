    ...
    <div class="page">
      ...
      <section class="section">
        <div class="section-inner">
          ...
          <p>
            The built-in transition system in VueJS is a breeze to use, but
            there is only so much you can do with CSS transitions. I wanted
            something more robust, but with same ease of use. Enter: Animeta.
          </p>
          <p>
            This VueJS library marries the awesome power of
            <a href="//animejs.com" target="_blank">AnimeJS</a> with Vue's great
            built-in transition system, allowing developers to effortlessly
            implement impressive animations and transitions in their Vue-based
            apps.
          </p>
          ...
          <div class="columns">
            <div class="column">
              <p>
                ...
                built-in
                <a
                  href="//vuejs.org/v2/guide/transitions.html#Transitioning-Single-Elements-Components"
                  target="_blank"
                  >VueJS transition</a
                >. The only difference is that instead of CSS, you pass a
                <strong>to</strong>, <strong>from</strong> and
                <strong>options</strong> object to the component to define the
                transition.
              </p>
              <p>
                You can find a full list of properties you can use in the
                <a href="//animejs.com/documentation" target="_blank"
                  >AnimeJS documentation</a
                >.
              </p>
              <div class="demo">
                <animeta-transition
